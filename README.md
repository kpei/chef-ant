...
* `node['ant']['url']` - the download url for the ant binary zip.  For windows installation it is recommended you set the URL to a zip file.
...
Installs Ant for the Windows platform using the OpsCode "windows" cookbook.  It is a modified script from
matschaffer (https://github.com/matschaffer/chef-loves-windows) that unzips ant, set ANT_HOME to the directory
and edit the environment Path to point to the bin.
